...
public class SSLs {
    ...
    public synchronized SSLSocketFactory getSSLSF(SSLProtocolVersion sslpv) throws KeyManagementException, NoSuchAlgorithmException {
        if (sslFactory != null)
            return sslFactory;
        try {
    ...
    public synchronized SSLConnectionSocketFactory getSSLCONNSF(SSLProtocolVersion sslpv) throws KeyManagementException, NoSuchAlgorithmException {
...
//	    	sc.init(null, new TrustManager[] { simpleVerifier }, null);
    ...
    public synchronized SSLIOSessionStrategy getSSLIOSS(SSLProtocolVersion sslpv) throws KeyManagementException, NoSuchAlgorithmException {
...
//			sc.init(null, new TrustManager[] { simpleVerifier }, null);
    ...
    private SSLs customSSL(String keyStorePath, String keyStorepass) throws Exception {
